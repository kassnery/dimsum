...
It is based on code by G. Cormode published here: http://hadjieleftheriou.com/frequent-items/index.html
Our additions to the code are the python scripts for evaluation (python/*), 
